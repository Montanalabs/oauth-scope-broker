...
- `oauth-scope-broker_safe.eide` — the correct design.
- `oauth-scope-broker_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
