...
- `oauth-scope-broker_safe.os` — the correct design.
- `oauth-scope-broker_unsafe.os` — the tempting-but-wrong version (the negative example a model must learn to reject).
